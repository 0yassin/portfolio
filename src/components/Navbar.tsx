...
export default function Navbar(){
    return(
      <motion.nav initial={{y:-30, opacity: 0}} animate={{y:0, opacity:1}} transition={{delay:0.8, duration:0.2}} className=" h-20 mx-auto max-w-[800px] pl-12 flex justify-between items-center border-[2.5px] border-primary rounded-full bg-transparent py-2">
