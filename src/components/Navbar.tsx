...
export default function Navbar(){
    ...
    return(
      ...
      <motion.nav initial={{y:-30, opacity: 0}} animate={{y:0, opacity:1}} transition={{delay:0.9, duration:0.2}} className=" h-20 md:mx-auto mx-4 mt-8 max-w-[800px] pl-6 md:pl-12 flex justify-between  items-center border-[1.3px] border-primary/60 rounded-full bg-transparent py-2">
